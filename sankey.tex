...
\begin{tikzpicture}[x=1pt,y=1pt]
  ...
  \begin{sankeydiagram}[
    ...
    \sankeyadvance{Qtuz}{50pt}

    \sankeyfork{Qtuz}{8.183/Q1,1.827/Qveszt}

    \sankeyturn{Qveszt}{-90}
    \sankeyadvance{Qveszt}{20pt}
    \sankeynodeend{1.827}{-90}{Qveszt}{Qveszt}


    \sankeyadvance{Q1}{50pt}
    \sankeyfork{Q1}{2.38/Q2, 5.792/Qkond}

    \sankeyturn{Qkond}{-90}
    \sankeyadvance{Qkond}{50pt}
    \sankeynodeend{5.792}{-90}{Qkond}{Qkond}

    \sankeyadvance{Q2}{120pt}
    \sankeyfork{Q2}{2.354/Q3, 0.026/Ptm}

    \sankeyturn{Ptm}{-90}
    \sankeyadvance{Ptm}{138pt}
    \sankeynodeend{0.026}{-90}{Ptm}{Ptm}

    \sankeyadvance{Q3}{30pt}
    \sankeyfork{Q3}{2.277/Q4, 0.077/Phm}

    \sankeyturn{Phm}{-90}
    \sankeyadvance{Phm}{138pt}
    \sankeynodeend{0.077}{-90}{Phm}{Phm}

    \sankeyadvance{Q4}{30pt}
    \sankeyfork{Q4}{2.195/Q5, 0.082/PgmPgv}

    \sankeyturn{PgmPgv}{-90}
    \sankeyadvance{PgmPgv}{139pt}
    \sankeynodeend{0.082}{-90}{PgmPgv}{PgmPgv}

    \sankeyadvance{Q5}{60pt}
    \sankeynodeend{2.195}{0}{Q5}{Q5}
